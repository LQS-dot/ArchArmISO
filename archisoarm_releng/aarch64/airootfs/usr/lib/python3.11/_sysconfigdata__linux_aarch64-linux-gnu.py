...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CC': 'gcc',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=armv8-a -O3 -pipe '
           '-fstack-protector-strong -fno-plt -fexceptions         '
           '-Wp,-D_FORTIFY_SOURCE=2 -Wformat -Werror=format-security         '
           '-fstack-clash-protection -march=armv8-a -O3 -pipe '
           '-fstack-protector-strong -fno-plt -fexceptions         '
           '-Wp,-D_FORTIFY_SOURCE=2 -Wformat -Werror=format-security         '
           '-fstack-clash-protection -march=armv8-a -O3 -pipe '
           '-fstack-protector-strong -fno-plt -fexceptions         '
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--enable-shared' '--with-computed-gotos' "
                ...
                "'--with-dbmliborder=gdbm:ndbm' '--with-system-libmpdec' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/python/src/Python-3.11.3/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/build/python/src/Python-3.11.3/lcov-report',
 ...
 'LIBEXPAT_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=armv8-a -O3 -pipe '
                    '-fstack-protector-strong -fno-plt -fexceptions         '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=armv8-a -O3 '
                             '-pipe -fstack-protector-strong -fno-plt '
                             '-fexceptions         -Wp,-D_FORTIFY_SOURCE=2 '
                             '-Wformat -Werror=format-security         '
                             '-fstack-clash-protection -march=armv8-a -O3 '
                             '-pipe -fstack-protector-strong -fno-plt '
                             '-fexceptions         -Wp,-D_FORTIFY_SOURCE=2 '
                             '-Wformat -Werror=format-security         '
                             '-fstack-clash-protection -march=armv8-a -O3 '
                             ...
                             '-fexceptions         -Wp,-D_FORTIFY_SOURCE=2 '
                             '-Wformat -Werror=format-security         '
                             '-fstack-clash-protection -std=c11 '
                             '-Werror=implicit-function-declaration '
                             '-fvisibility=hidden  -I./Include/internal -I. '
                             '-I./Include -fPIC -DPy_BUILD_CORE_BUILTIN',
 'PY_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=armv8-a -O3 -pipe '
              '-fstack-protector-strong -fno-plt -fexceptions         '
              '-Wp,-D_FORTIFY_SOURCE=2 -Wformat '
              '-Werror=format-security         -fstack-clash-protection '
 ...
 'PY_CORE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=armv8-a -O3 -pipe '
                   '-fstack-protector-strong -fno-plt -fexceptions         '
                   '-Wp,-D_FORTIFY_SOURCE=2 -Wformat '
                   '-Werror=format-security         -fstack-clash-protection '
                   '-march=armv8-a -O3 -pipe -fstack-protector-strong -fno-plt '
 ...
 'PY_LDFLAGS': '-Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now '
               '-Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now '
                     '-Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now',
 'PY_SQLITE_ENABLE_LOAD_EXTENSION': 1,
 'PY_SQLITE_HAVE_SERIALIZE': 1,
 'PY_SSL_DEFAULT_CIPHERS': 1,
 'PY_SSL_DEFAULT_CIPHER_STRING': 0,
 'PY_STDMODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=armv8-a -O3 '
                        '-pipe -fstack-protector-strong -fno-plt '
                        '-fexceptions         -Wp,-D_FORTIFY_SOURCE=2 -Wformat '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/python/src/Python-3.11.3',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-ldl',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/python/src/Python-3.11.3 ./python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/python/src/Python-3.11.3 ./python -E '
 ...
 'abs_builddir': '/build/python/src/Python-3.11.3',
 'abs_srcdir': '/build/python/src/Python-3.11.3',
