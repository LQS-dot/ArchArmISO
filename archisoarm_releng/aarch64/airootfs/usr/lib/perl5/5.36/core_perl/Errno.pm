...
"aarch64-linux-thread-multi-5.12.15-arch1-1" or
	die "Errno architecture (aarch64-linux-thread-multi-5.12.15-arch1-1) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
