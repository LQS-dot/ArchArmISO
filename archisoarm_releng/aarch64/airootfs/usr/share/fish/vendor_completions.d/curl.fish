...
complete --command curl --long-option 'haproxy-clientip' --description 'Sets the HAProxy PROXY protocol v1 client IP' 
...
complete --command curl --long-option 'trace-ids' --description 'Add transfer/connection identifiers to trace/verbose output' 
